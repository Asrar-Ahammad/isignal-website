        ...
        <>
            ...
            <div className="main-4gcbody">
                ...
                <ProductPara
                    ...
                    contentPara="To set up a 4G cloud on AWS, you can use iSignal's software and hardware solutions. iSignal's software can automate the deployment and management of 4G networks on AWS, and its hardware solutions are designed to work with AWS. However, iSignal's solutions can be expensive, and they can be complex to use."
                    contentImg1={img1}
                />
            </div>
            <Footer />
