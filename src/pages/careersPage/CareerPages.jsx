...
function CareerPages() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_ztk8ac5', 'template_bkorjj8', form.current, 'HxqosoPu0XQ1wh8Yt')
      .then((result) => {
      ...
      <div className="formContainer">
        ...
        <div className="conForm">
          <form ref={form} onSubmit={sendEmail}>
            ...
            <input type="email" name='from_email' placeholder='you@company.com' required />
            <input type="tel" name='phone' placeholder='123-456-7890' required />
            <input type="text" name='job_role' placeholder='Position applying for...' required />
            <input type="text" name='resume' id='resume' placeholder='Resumé link' required />
